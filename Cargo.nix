  ...
  internal = rec {
    ...
    crates = {
      ...
      "h2 0.3.25" = rec {
        ...
        version = "0.3.25";
        edition = "2018";
        sha256 = "1sqq8rnv3vrwra7wzgc6099j9zw80rnm9aslhsa8d674qlh2igag";
        authors = [
          "Carl Lerche <me@carllerche.com>"
          "Sean McArthur <sean@seanmonstar.com>"
        ];
      ...
      "hyper-rustls" = rec {
        ...
        resolvedDefaultFeatures = [ "acceptor" "default" "http1" "log" "logging" "native-tokio" "ring" "rustls-native-certs" "tls12" "tokio-runtime" "webpki-roots" ];
      };
      "hyper-timeout" = rec {
      ...
      "libaes" = rec {
        ...
        version = "0.7.0";
        edition = "2018";
        sha256 = "1drvgng5hpjwnmahdwn3w8g30z62b20vdabjmgsidf09q1h37442";
        authors = [
      ...
      "libsql" = rec {
        ...
        version = "0.3.2";
        edition = "2021";
        sha256 = "14sps92j0ngassk9gayk9qc8cgk58n917yn8v16zsid2h3ns8y9q";
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
          ...
          {
            name = "libsql-hrana";
            packageId = "libsql-hrana";
            optional = true;
          }
          {
            name = "libsql-sqlite3-parser";
            packageId = "libsql-sqlite3-parser";
            rename = "sqlite3-parser";
            optional = true;
          }
          {
            name = "libsql-sys";
            packageId = "libsql-sys";
            optional = true;
          }
          {
            name = "libsql_replication";
            packageId = "libsql_replication";
            optional = true;
          }
          {
            name = "parking_lot";
          ...
          }
          {
            ...
            optional = true;
            features = [ "trace" "set-header" "util" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
        ...
        features = {
          ...
          "core" = [ "libsql-sys" "dep:bitflags" "dep:bytes" "dep:futures" ];
          "default" = [ "core" "replication" "remote" ];
          "encryption" = [ "core" "libsql-sys/encryption" "dep:bytes" ];
          "hrana" = [ "parser" "serde" "stream" "dep:base64" "dep:serde_json" "dep:futures" "dep:tokio" "dep:tokio-util" "dep:bytes" "dep:libsql-hrana" ];
          "libsql-sys" = [ "dep:libsql-sys" ];
          "parser" = [ "dep:sqlite3-parser" "dep:fallible-iterator" ];
          "remote" = [ "hrana" "dep:tower" "dep:hyper" "dep:http" "dep:tokio" "dep:futures" "dep:bitflags" "dep:tower" "dep:hyper-rustls" ];
          "replication" = [ "core" "parser" "serde" "stream" "dep:tower" "dep:hyper" "dep:http" "dep:tokio" "dep:anyhow" "dep:bincode" "dep:zerocopy" "dep:bytes" "dep:uuid" "dep:tokio-stream" "dep:parking_lot" "dep:tokio" "dep:tonic" "dep:tonic-web" "dep:tower-http" "dep:tower" "dep:hyper-rustls" "dep:futures" "dep:libsql_replication" ];
          "serde" = [ "dep:serde" ];
          "stream" = [ "dep:futures" "dep:async-stream" ];
          "wasm" = [ "hrana" ];
        };
        resolvedDefaultFeatures = [ "core" "default" "hrana" "libsql-sys" "parser" "remote" "replication" "serde" "stream" ];
      };
      "libsql-ffi" = rec {
        crateName = "libsql-ffi";
        version = "0.2.1";
        edition = "2021";
        sha256 = "1f90cpi48fkfxgw39yh2wqh581i6m01dfbzviga0dvc5cl60nypn";
        buildDependencies = [
          {
            name = "bindgen";
            packageId = "bindgen";
      ...
      "libsql-hrana" = rec {
        crateName = "libsql-hrana";
        version = "0.1.0";
        edition = "2021";
        sha256 = "0shiwsw0y8cl0qajf08gcwf9dxfnf4s2acvi0s78114fr72mdwj0";
        dependencies = [
          {
            name = "base64";
            packageId = "base64";
      ...
      "libsql-rusqlite" = rec {
        crateName = "libsql-rusqlite";
        version = "0.30.0";
        edition = "2018";
        sha256 = "0ap1myfdrkq3svqpgcym2wsxza38n9xdrg5b5dln3c4ckfzfj9v2";
        libName = "rusqlite";
        authors = [
        ...
        resolvedDefaultFeatures = [ "column_decltype" "functions" "libsql-experimental" "limits" "load_extension" "modern_sqlite" "trace" ];
      };
      "libsql-sqlite3-parser" = rec {
        crateName = "libsql-sqlite3-parser";
        version = "0.11.1";
        edition = "2021";
        sha256 = "0lhppi586xl9vlhjchx93wsl9k1hv9lrydlbwi9c3jd50bvjqp89";
        authors = [
          "gwenn"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = [ "YYNOERRORRECOVERY" "default" ];
      };
      "libsql-sys" = rec {
        crateName = "libsql-sys";
        version = "0.4.0";
        edition = "2021";
        sha256 = "0x57mng8vp1c691vwyw6y2dyaablfxzmlda5ganmpmz44lmfyq72";
        dependencies = [
          {
            name = "bytes";
            packageId = "bytes";
          ...
          }
          {
            ...
            packageId = "libsql-rusqlite";
            rename = "rusqlite";
            optional = true;
            usesDefaultFeatures = false;
            features = [ "libsql-experimental" "column_decltype" "load_extension" "modern_sqlite" "functions" "limits" "trace" ];
          }
          {
            name = "once_cell";
            packageId = "once_cell";
        ...
        features = {
          ...
          "hrana" = [ "serde" "dep:prost" "dep:base64" ];
          "rusqlite" = [ "dep:rusqlite" ];
          "serde" = [ "dep:serde" ];
          "wasmtime-bindings" = [ "libsql-ffi/wasmtime-bindings" ];
        };
        resolvedDefaultFeatures = [ "api" "default" "rusqlite" "wal" ];
      };
      "libsql_replication" = rec {
        crateName = "libsql_replication";
        version = "0.3.0";
        edition = "2021";
        sha256 = "0gk5iycq91g4yxrjrajdpk2x5mml6gpfqkd5qrqj87ddqxilc1ix";
        dependencies = [
          {
            name = "aes";
            packageId = "aes";
          ...
          }
          {
            ...
            rename = "rusqlite";
            usesDefaultFeatures = false;
            features = [ "libsql-experimental" "column_decltype" "load_extension" "modern_sqlite" "functions" "limits" ];
          }
          {
            name = "libsql-sys";
            packageId = "libsql-sys";
            usesDefaultFeatures = false;
            features = [ "wal" "rusqlite" "api" ];
          }
          {
            name = "parking_lot";
            packageId = "parking_lot";
      ...
      "reqwest" = rec {
        ...
        version = "0.12.2";
        edition = "2021";
        sha256 = "0f1k1qdy04m66pwzcg58zp9arpz3qhd3qypabrk69f3g5d7nfrid";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
      ...
      "syn" = rec {
        ...
        version = "2.0.55";
        edition = "2021";
        sha256 = "1w5qxgrqp6vyrk4347dajjwvf2xbfzrx0m96qfpxyzlnpwyinah0";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "tonic" = rec {
        ...
        resolvedDefaultFeatures = [ "channel" "codegen" "default" "prost" "tls" "tls-roots" "tls-roots-common" "tls-webpki-roots" "transport" ];
      };
      "tonic-web" = rec {
        crateName = "tonic-web";
        version = "0.10.2";
      ...
      "tower-http" = rec {
        ...
        resolvedDefaultFeatures = [ "cors" "default" "set-header" "tower" "trace" "tracing" "util" ];
      };
      "tower-layer" = rec {
