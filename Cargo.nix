...
let
  nixifiedLockHash = "d71d45977ba5d788c39d9f17b48ad90e04be555b26045f2a55da54020aad54e4";
...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-config."1.5.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.60.8" { inherit profileName; }).out;
      ...
      aws_smithy_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.6.0" { inherit profileName; }).out;
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-route53."1.34.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-route53";
    version = "1.34.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "af54aa1e6bf45834bcf78262166c59fce1f019d15e3c6db4d14f8258d80451bd"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "rt-tokio" ]
      [ "rustls" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.60.8" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-http";
    version = "0.60.8";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4a7de001a1b9a25601016d8057ea16e31a45fdca3751304c8edf4ad72e706c08"; };
    dependencies = {
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.0" { inherit profileName; }).out;
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.2.0" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.6.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.6.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-runtime";
    version = "1.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "db83b08939838d18e33b5dbaf1a0f048f28c10bd28071ab7ce6f245451855414"; };
    features = builtins.concatLists [
      [ "client" ]
    ...
    dependencies = {
      ...
      http_body_1 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".http-body."1.0.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-runtime-api";
    version = "1.7.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1b570ea39eb95bd32543f6e4032bce172cb6209b9bc8c83c770d08169e875afc"; };
    features = builtins.concatLists [
      [ "client" ]
      [ "default" ]
      [ "http-02x" ]
  ...
  "unknown".bootstrap."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      aws_sdk_route53 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-route53."1.34.0" { inherit profileName; }).out;
      dotenv = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".dotenv."0.15.0" { inherit profileName; }).out;
      hex = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".hex."0.4.3" { inherit profileName; }).out;
      libaes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libaes."0.7.0" { inherit profileName; }).out;
      libsql = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libsql."0.3.5" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libaes."0.7.0" = overridableMkRustCrate (profileName: rec {
    name = "libaes";
    version = "0.7.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "82903360c009b816f5ab72a9b68158c27c301ee2c3f20655b55c5e589e7d3bb7"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libsql."0.3.5" = overridableMkRustCrate (profileName: rec {
    name = "libsql";
    version = "0.3.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1bd17bcc143f2a5be449680dc63b91327d953bcabebe34a69c549fca8934ec9d"; };
    features = builtins.concatLists [
      [ "core" ]
      [ "default" ]
      [ "hrana" ]
    ...
    dependencies = {
      ...
      libsql_hrana = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libsql-hrana."0.1.1" { inherit profileName; }).out;
      sqlite3_parser = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libsql-sqlite3-parser."0.11.1" { inherit profileName; }).out;
      libsql_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libsql-sys."0.5.0" { inherit profileName; }).out;
      libsql_replication = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libsql_replication."0.3.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libsql-ffi."0.2.1" = overridableMkRustCrate (profileName: rec {
    name = "libsql-ffi";
    version = "0.2.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f67a0b0c6585ed06d48bfb2fd702a826065420e602fa34f8eb6e3a44e26520b9"; };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libsql-hrana."0.1.1" = overridableMkRustCrate (profileName: rec {
    name = "libsql-hrana";
    version = "0.1.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "220a925fe6d49dbfa7523b20f5a5391f579b5d9dcf9dd1225606d00929fcab3a"; };
    dependencies = {
      base64 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.21.7" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.6.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libsql-rusqlite."0.30.0" = overridableMkRustCrate (profileName: rec {
    name = "libsql-rusqlite";
    version = "0.30.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6227e9be9b8cb061692babbcdc7ab268a8df3517d5b377f1d603cfdc9cafe12a"; };
    features = builtins.concatLists [
      [ "column_decltype" ]
      [ "functions" ]
      [ "libsql-experimental" ]
    ...
    dependencies = {
      ...
      libsql_ffi = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libsql-ffi."0.2.1" { inherit profileName; }).out;
      smallvec = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.13.2" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".libsql-sqlite3-parser."0.11.1" = overridableMkRustCrate (profileName: rec {
    name = "libsql-sqlite3-parser";
    version = "0.11.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "095d2cf702a5c9c152e48b369f69da30cc44351fa9432621dd8976834abc1752"; };
    features = builtins.concatLists [
      [ "YYNOERRORRECOVERY" ]
      [ "default" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libsql-sys."0.5.0" = overridableMkRustCrate (profileName: rec {
    name = "libsql-sys";
    version = "0.5.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5829f758a82418429de6cb0eb310502de78d0908efc3fe2f84b6a41f2f6bebd1"; };
    features = builtins.concatLists [
      [ "api" ]
      [ "default" ]
      [ "rusqlite" ]
    ...
    dependencies = {
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.6.0" { inherit profileName; }).out;
      libsql_ffi = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libsql-ffi."0.2.1" { inherit profileName; }).out;
      rusqlite = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libsql-rusqlite."0.30.0" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.19.0" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.40" { inherit profileName; }).out;
      zerocopy = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".zerocopy."0.7.34" { inherit profileName; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libsql_replication."0.3.1" = overridableMkRustCrate (profileName: rec {
    name = "libsql_replication";
    version = "0.3.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ef903dda0e85af2224e7454380e59d9602738a5041546a4807438951ad0d5b25"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".zerocopy."0.7.34" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      zerocopy_derive = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".zerocopy-derive."0.7.34" { profileName = "__noProfile"; }).out;
    };
  });
